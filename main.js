...
if($('.slider-full').length>0){
	$('.slider-full').slick({
		...
		nextArrow:'<button type="button" class="slick-next">след <img src="img/full/slider/Arrowr.svg" alt="" /></button>',
		prevArrow:'<button type="button" class="slick-prev"><img src="img/full/slider/Arrowl.svg" alt="" /> пред</button>',
		responsive: [{
			breakpoint: 768,
			settings: {}
		}]
